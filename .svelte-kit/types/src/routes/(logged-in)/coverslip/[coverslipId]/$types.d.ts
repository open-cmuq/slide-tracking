...
type RouteParams = { coverslipId: string }
type RouteId = '/(logged-in)/coverslip/[coverslipId]';
...
type LayoutRouteId = RouteId | "/(logged-in)/coverslip/[coverslipId]" | "/(logged-in)/coverslip/[coverslipId]/files" | "/(logged-in)/coverslip/[coverslipId]/staining"
type LayoutParams = RouteParams & { coverslipId?: string }
